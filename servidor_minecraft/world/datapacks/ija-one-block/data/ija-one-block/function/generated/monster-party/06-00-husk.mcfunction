...
execute at @s run summon minecraft:husk ~ ~1.6 ~ {"equipment":{"head":{"id":"minecraft:iron_helmet","count":1},"chest":{"id":"minecraft:leather_chestplate","count":1},"legs":{"id":"minecraft:iron_leggings","count":1},"feet":{"id":"minecraft:leather_boots","count":1},"mainhand":{"id":"minecraft:iron_sword","count":1}},"CustomName":{"translate":"ija.oneblock.tl.27","fallback":"Monster Guard","color":"dark_red"},"Tags":["ija-a4-monster-party-mob"]}
