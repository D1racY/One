...
execute at @s run summon minecraft:piglin_brute ~ ~1.6 ~ {"equipment":{"head":{"id":"minecraft:golden_helmet","count":1},"chest":{"id":"minecraft:golden_chestplate","count":1},"legs":{"id":"minecraft:golden_leggings","count":1},"feet":{"id":"minecraft:golden_boots","count":1},"mainhand":{"id":"minecraft:golden_axe","count":1}},"CustomName":{"translate":"ija.oneblock.tl.27","fallback":"Monster Guard","color":"dark_red"},"Tags":["ija-a4-monster-party-mob"]}
