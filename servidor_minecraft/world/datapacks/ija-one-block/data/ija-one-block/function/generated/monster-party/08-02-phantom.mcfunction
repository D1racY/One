...
execute at @s run summon minecraft:phantom ~ ~1.6 ~ {"attributes":[{"id":"minecraft:burning_time","base":0}],"CustomName":{"translate":"ija.oneblock.tl.27","fallback":"Monster Guard","color":"dark_red"},"Tags":["ija-a4-monster-party-mob"]}
