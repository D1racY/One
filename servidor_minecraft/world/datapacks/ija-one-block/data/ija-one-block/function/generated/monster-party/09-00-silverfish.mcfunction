...
execute at @s run summon minecraft:silverfish ~ ~1.6 ~ {"CustomName":{"translate":"ija.oneblock.tl.27","fallback":"Monster Guard","color":"dark_red"},"Tags":["ija-a4-monster-party-mob"]}
execute if entity @s[scores={ija-a4-random-mob-amount=2..}] at @s run summon minecraft:silverfish ~ ~1.6 ~ {"CustomName":{"translate":"ija.oneblock.tl.27","fallback":"Monster Guard","color":"dark_red"},"Tags":["ija-a4-monster-party-mob"]}
