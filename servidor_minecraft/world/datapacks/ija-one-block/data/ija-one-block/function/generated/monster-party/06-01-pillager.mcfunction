...
execute at @s run summon minecraft:pillager ~ ~1.6 ~ {"equipment":{"mainhand":{"id":"minecraft:crossbow","count":1}},"CustomName":{"translate":"ija.oneblock.tl.27","fallback":"Monster Guard","color":"dark_red"},"Tags":["ija-a4-monster-party-mob"]}
